    ...
    >
      ...
      <div className="grid sm:grid-cols-[auto_1fr] mt-[25rem] gap-6 justify-center sm:justify-items-start justify-items-center">
        ...
        <div className="sm:self-end">
          <div className="flex items-center gap-3 justify-center justify-items-center  sm:justify-start  mb-4">
            <a
              href={data.spotifyLink}
              target="_blank"
              className="inline-block after:h-[2px] hover:after:bg-smoke after:block "
            >
      ...
      <div className="grid md:grid-cols-[1fr_0.5fr] mt-16 justify-between gap-16">
        <ReviewForm />
